...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function () {
            ...
            $('#grid').datagrid('options').url = "/WorkFlow/TraceApplySearch/?flowType=" + $('#flowType').combobox('getValue') + "&startTime=" + $("#startTime").datetimebox('getText') + "&endTime=" + $('#endTime').datetimebox('getText') + "&flowNo=" + $('#flowNo').val();
        ...
        function formatCharge(val, rec) {
            ...
            if (rec.IsInner == "Y" && IsApply(rec.State)) {
                ...
                title = '追寻申请--&gt;' + rec.FlowName + "[" + rec.FlowNo + "]";
            }
