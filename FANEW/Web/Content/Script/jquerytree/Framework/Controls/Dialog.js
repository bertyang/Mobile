...
Dialog.prototype.show = function() {
    ...
    if (bgdiv.style.display == "none") {
        ...
        if (this.Animator) {
            $E.show(bgdiv);
            pw.Effect.fade(bgdiv, 2, 3, isIE6 ? 5 : 4);
        } else {
            pw.Effect.setAlpha(bgdiv, 5)
            $E.show(bgdiv);
        }
    }
...
//    if (this.ID != "MediaPlayer") {
//        if (this.ID != "diagAccidentEvent" && this.ID != "diagTaskPatient")//0417shw

//        parent.autoclick(); //LGY
//    }
