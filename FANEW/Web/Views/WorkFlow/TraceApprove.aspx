...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function () {
            ...
            $('#grid').datagrid('options').url = "/WorkFlow/TraceApproveSearch/?flowType=" + $('#flowType').combobox('getValue') + "&startTime=" + $("#startTime").datetimebox('getText') + "&endTime=" + $('#endTime').datetimebox('getText') + "&flowNo=" + $('#flowNo').val();
        ...
        function formatCharge(val, rec) {
            ...
            var title = '追寻签核--&gt;' + rec.FlowName + "[" + rec.FlowNo + "]";

            return "<span style='color:red;'><a href='#' onclick=AddTab('" + title + "','" + src + "','tu0804')><u>" + rec.FlowName + "</u></a></span>";
        }
             ...
             >
                <thead>
		            <tr>
                        ...
                        <th field="ApproveDate" width="100"  align='center' formatter='renderTime' sortable="true">签核时间</th>
