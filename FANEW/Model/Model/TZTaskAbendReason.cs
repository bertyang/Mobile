...
{
	[Table(Name = "TZTaskAbendReason")]
	public class TZTaskAbendReason
	{
		private int _编码;
		/// <summary>
		/// 编码
		...
		private bool _事件是否挂起;
		/// <summary>
		/// 事件是否挂起
		/// </summary>
		[Column(Name = "事件是否挂起", DbType = "bit", Storage = "_事件是否挂起", UpdateCheck = UpdateCheck.Never)]
		public bool 事件是否挂起
		{
			get { return _事件是否挂起; }
			set { _事件是否挂起 = value; }
