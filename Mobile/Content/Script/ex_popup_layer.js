...
var PopupLayer = new Class({
  ...
  var _t9;
function Init_Popup_Layer(trigger,popupBlk,closeBtn)
{
//trigger: "#btnModifyPWD", popupBlk: "#blk3", closeBtn: "#close3"
  _t9 = new PopupLayer({ trigger: trigger, popupBlk: popupBlk, closeBtn: closeBtn, useOverlay: true, useFx: true,
                offsets: {
                    x: 0,
                    y: -41
                }
            });
            _t9.doEffects = function(way) {
                if (way == "open") {
...
/*使用
添加div  是弹出层窗口   引用core.css   style文件  定义一个变量初始化PopupLayer  如 initpl = Init_Popup_Layer("#aef", "#blk3", "#close3");三个参数见前面。
 <div id="blk3" class="blk" style="display: none;">
    <div class="blkmain">
        <h2>
            修改密码</h2>
        <a href="javascript:void(0)" id="close3" class="closeBtn">×</a>
        <div class="main_table">
            <table border="0"  width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <a href="#" class="easyui-linkbutton" plain="true" onclick="javascript:initpl.close();" > 确定</a>
                    </td>
                </tr>
            </table>
            </div>
