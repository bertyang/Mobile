    ...
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/css").Include(
                        "~/Content/easyui1.3.3/themes/default/easyui.css",
                        "~/Content/easyui1.3.3/themes/icon.css",
            ...
            if (AppConfig.NetworkSegment)
            {
                bundles.Add(new ScriptBundle("~/bundles/js").Include(
                            ...
                            "~/Content/easyui1.3.3/jquery.easyui.min.js",
                            "~/Content/easyui1.3.3/locale/easyui-lang-zh_CN.js",
            ...
            bundles.Add(new StyleBundle("~/Contents/css").Include(
                       "~/Content/easyui1.4.2/themes/default/easyui.css",
                       "~/Content/easyui1.4.2/themes/icon.css",
                       "~/Content/css/default.css"));

            bundles.Add(new ScriptBundle("~/bundle/js").Include(
                        "~/Content/Script/jquery-1.8.0.min.js",
                        "~/Content/easyui1.4.2/jquery.easyui.min.js",
                        "~/Content/easyui1.4.2/locale/easyui-lang-zh_CN.js",
                        "~/Content/Script/jquery.tips.js",
                        "~/Content/Script/datagrid-detailview.js",
                        "~/Content/Script/jquery.maskedinput-1.2.2.js",
                        "~/Content/Script/Tab.js"));
