...
<body>
    <div>
        <% 
            ...
            //{
            //Anchor.FA.Model.TParameterAcceptInfo tpa = 
            //    new Anchor.FA.Model.TParameterAcceptInfo();
            //    if(tpa.是否可见)
            //    {
            //        return tpa.默认值;
            //    }
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
            ...
            <tr>
                <td style="padding: 0 8px 4px;" align="center">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="TaskTable">
                        <tr>
                            <td>
                            <div id="divPt">
<%--                                    <a href="#" class="icon-edit" title="修改"></a>
                                    <a href="#" class="icon-tip" title="查看修改记录"></a>
                                    <a href="#" class="icon-print" title="打印"></a>--%>
                            </div>
                                <div id="divTae" class="easyui-panel" title="事件详细信息[<%:tae.EventCode%>]" style="width: 1000px;
                        ...
                        <tr>
                            <td>
                                <div class="This_header" style="width: 988px">
                                    ...
                                    <div class="panel-tool">
                                        <a href="#" class="icon-add panel-tool-a" title="关联新录音" 
                                        onclick="javascript:Connect('<%:tae.EventCode%>');return false;"></a>
                                    </div>
                        ...
                        <tr>
                            <td>
                                <div id="divAcceptEvent" class="easyui-tabs" tabposition="left" style="width: 1000px;
                                    height: 1100px">
                                    <% 
                                        int i = 1;
                                    ...
                                    %>
                                    <div title="第<%: i++ %>次受理" style="padding: 10px" data-options="tools:'#divAcceptEventEdite'">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <% 
                                            ...
                                            {
                                        %>
                                        <div class="This_header" style="width: auto">
                                            <div class="This_title">
                                                任务车辆信息</div>
                                        </div>
                                        <div id="divTask" class="easyui-tabs" style="width: 800; height: auto">
                                            <% 
                                                foreach (Anchor.FA.Model.C_Task ttAll in tacAll.TT)
                                                {
                                                    Anchor.FA.Model.C_TaskInfoDetail tInfo = ttAll.tt;
                                            %>
                                            <div title="<%: tInfo.TradeMark %>&nbsp;&nbsp;[<%: tInfo.Code%>]" style="padding: 10px">
