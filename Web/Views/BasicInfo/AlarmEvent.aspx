...
<body class="easyui-layout">
    <div region="center" style="padding: 5px" border="true">
        <table id="grid" class="easyui-datagrid" align="center" toolbar="#tb"
            pagination="true" pagenumber="1" pagelist="[20, 25, 30]" pagesize="15" idfield="id"
            fitcolumns="true" nowrap="false" striped="true" rownumbers="true" singleselect="true"
            sortname="time" sortorder="desc" remotesort="false" width="1000px" fit="true">
            <%--            <thead frozen="true">
                <tr>
    ...
    <div id="tb" style="padding: 5px; height: auto; display: none">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" height="10%">
            <tr>
                ...
                <td>
                    <input id="txt_TelCode" class="easyui-validatebox" style="border: 1px solid #8DB2E3;
                ...
                <td>
                    <input id="txt_SuffererName" class="easyui-validatebox" style="border: 1px solid #8DB2E3;
                        width: 144px; height: 15px;" />
                </td>
                <td>
                    &nbsp;
                ...
                <td>
                    <a href="#" class="easyui-linkbutton" iconcls="icon-search" onclick="Search(1);return false;">查询</a>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input id="c_BeginDate" class="easyui-datebox" style="width: 90px" value="" />
                    <input id="c_BeginTime" class="easyui-validatebox" style="border: 1px solid #8DB2E3;
                        width: 50px; height: 15px" value="">
                </td>
                <td>
                    &nbsp;
                </td>
                ...
                <td>
                    <input id="c_EndDate" class="easyui-datebox" style="width: 90px" value="" />
                    <input id="c_EndTime" class="easyui-validatebox" style="border: 1px solid #8DB2E3;
                        width: 50px; height: 15px" value="">
                </td>
                <td>
                    &nbsp;
                ...
                <td>
                    <input id="AlarmEventCode" class="easyui-validatebox" style="border: 1px solid #8DB2E3;
                        width: 144px; height: 15px;">
                </td>
                <td>
                    &nbsp;
                ...
                <td>
                    <input id="txt_ZhuSu" class="easyui-validatebox" style="border: 1px solid #8DB2E3;
                        width: 144px; height: 15px;">
                </td>
                <td>
                    &nbsp;
            ...
            <tr>
                ...
                <td>
                    <input id="Driver" class="easyui-validatebox" style="border: 1px solid #8DB2E3; width: 144px;
                        height: 15px;" />
                </td>
                <td>
                    &nbsp;
                ...
                <td>
                    <input id="Doctor" class="easyui-validatebox" style="border: 1px solid #8DB2E3; width: 144px;
                        height: 15px;" />
                </td>
                <td>
                    &nbsp;
                ...
                <td>
                    <input id="Nurse" class="easyui-validatebox" style="border: 1px solid #8DB2E3; width: 144px;
                        height: 15px;" />
                </td>
                <td>
                    &nbsp;
                ...
                <td>
                    <input class="easyui-combobox" style="width: 150px;" panelheight="400px" id="txt_Dis"
                        editable="false" />
                </td>
                <td>
                    &nbsp;
            ...
            <tr>
                ...
                <td>
                    <input class="easyui-combobox" style="width: 150px;" panelheight="400px" id="txt_Station"
                        editable="false" />
                </td>
                <td>
                    &nbsp;
                ...
                <td>
                    <input class="easyui-combobox" style="width: 150px;" panelheight="400px" id="txt_Alums"
                        editable="false" />
                </td>
                <td>
                    &nbsp;
                ...
                <td>
                    <input class="easyui-combobox" style="width: 150px;" panelheight="200px" id="AlarmTypes"
                        editable="false" />
                </td>
                <td>
                    &nbsp;
                ...
                <td>
                    <input class="easyui-combobox" style="width: 150px;" panelheight="120px" id="OriTypes"
                        editable="false" />
                </td>
                <td>
                    &nbsp;
            ...
            <tr>
                ...
                <td>
                    <input id="txt_LocalAddr" class="easyui-validatebox" style="border: 1px solid #8DB2E3;
                        width: 144px; height: 15px;">
                </td>
                <td>
                    &nbsp;
                ...
                <td>
                    <input id="txt_SendAddress" class="easyui-validatebox" style="border: 1px solid #8DB2E3;
                        width: 144px; height: 15px;">
                </td>
                <td>
                    &nbsp;
                ...
                <td>
                    <input class="easyui-combobox" style="width: 150px;" panelheight="200px" id="IllState"
                        editable="false" />
                </td>
                <td>
                    &nbsp;
                ...
                <td>
                    <input class="easyui-combobox" style="width: 150px;" panelheight="120px" id="IsTest"
                        editable="false" />
                </td>
...
<%--                <td colspan="5" align="right">
                ...
                <td>
                    ...
                    <a href="#" class="easyui-linkbutton" iconcls="icon-tip" onclick="openPwd();return false;">查看</a>
                </td>--%>
            </tr>
             <tr>
                 <td>
                ...
                <td>
                    <input id="txt_Judge" class="easyui-validatebox" style="border: 1px solid #8DB2E3;
                        width: 144px; height: 15px;">
                </td>
            </tr>
        </table>
