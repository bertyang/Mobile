...
<body class="easyui-layout">
    <div region="center" border="false">
        <div region="north" style="margin-left: 40px; margin-top: 20px; height: 40px">
            <span class="editTitle">台通知</span>
        </div>
        <div region="center">
            <form id="form" method="post" runat="server" action="/Notice/SendDesk/" enctype="application/x-www-form-urlencoded">
            <table width="100%">
                <tr>
                ...
                <tr style="height: 340px;">
                    <td colspan="2" align="right" >
                        <table id="grid" class="easyui-datagrid" url="/Notice/DeskLoad/?ActionId=<%=Request.QueryString["ActionId"]%>"
                           idfield="台号" rownumbers="true"  sortorder="asc" fit="true" fitcolumns="true">
                            <thead frozen="true">
                                <tr>
                                    <th field="台号" width="30px" checkbox="true" align='center'>
                                        台号
                                    </th>
                                </tr>
                            </thead>
                            <thead>
                                <tr>
                                    <th field="显示名称" width="90px" align='center'>
                                        显示名称
                                    </th>
                ...
                <tr style="display: none">
                    <td colspan="4">
                        ...
                        <input id="isBrodcast" type="text" name="isBrodcast"/>
                    </td>
                </tr>
                <tr>
                    <td align=right>
        ...
        <table style="width: 100%">
            <tr>
                ...
                <td style="text-align: LEFT">
                    ...
                    <a href="#" id="cancel" class="easyui-linkbutton" iconcls="icon-cancel" onclick="window.location.href ='/Notice/SendDeskNotice/';">
                        取消</a>
                </td>
            </tr>
        </table>
