...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
            ...
            $('#btnSearch').bind('click',
                    function () {
                        if (document.getElementById('ch').checked == true) {
                            window.location = "/Knowledge/Danger/?type=1&chineseName=" + escape($('#name').val());
                        }
                        else {
                            window.location = "/Knowledge/Danger/?type=0&englishName=" + escape($('#name').val());
                        }
                    }
               );
        });
        ...
        function Selected() {
                if (document.getElementById('ch').checked == true) {
                    var url = "/Knowledge/DangerDetail/?id=" + $("#Chinese").val();
                    $('#frame').attr("src", url);
                }
                else {
                    var url = "/Knowledge/DangerDetail/?id=" + $("#English").val();
                    $('#frame').attr("src", url);
                }                   
        }
    </script>
...
<body class="easyui-layout"> 
    <div region="west" split="true"  title="化学危险品列表" style=" width:180px; overflow:hidden; border:true">
        ...
        <div region="center" style="width: 100%; height: 100%; overflow-y: auto; border: solid 1px black">
            <select id="Chinese" multiple="multiple" style="width: 100%; height: 82%;display: none" onchange="Selected();">
                <% foreach (var entity in ((dynamic)ViewData["danger"])){ %>
    ...
    <div region="center" border="true" style="overflow-y: hidden"  title="化学危险品详细内容" >
        <iframe id="frame" scrolling="auto" frameborder="0"  src="/Knowledge/DangerDetail/?id=<%=ViewData["id"]%>" style="width:100%;height:100%;"></iframe>
    </div>
</body>
</html>
